        ...
        {!submitted && (
          <div className="flex flex-grow flex-col items-center">
            ...
            <p className="max-w-4xl pb-8 text-center font-medium">
              Join one of the best street teams in the country! Connect with
              other fans, earn free tickets, chances to meet artists, and so
              much more. Fill out the form below and someone from Vital will
